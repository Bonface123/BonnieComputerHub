        ...
        <div class="grid gap-10 md:grid-cols-3 rounded-lg bg-white shadow-md p-8">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="<?php echo getBaseUrl(); ?>pages/courses.php" class="text-gray-600 hover:text-yellow-400 transition hover:border-l-2 hover:border-yellow-400 hover:bg-yellow-100 py-2 px-4 rounded flex items-center">
